                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="tblpengajuandisetujui" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach($vidcon_disetujui as $vd): ?>
                                            <tr>
                                                <td><?= $i++ ?></td>
                                                <td><?= $vd['nomorsurat'] ?></td>
                                                ...
                                                <td style="white-space: nowrap;"><a class="btn btn-primary btn-circle btn-detail" data-tooltip="tooltip" data-toggle="modal" data-target="#modaldetailpengajuan" data-placement="top" title="Lihat rincian" 
                                                    ...
                                                    <a class="btn btn-danger btn-circle btn-tolak" data-tooltip="tooltip" data-toggle="modal" data-placement="top" data-target="#modaltolakpengajuan" title="Tolak pengajuan ini" data-url="<?=site_url("pengajuan/tolakpengajuan/".$vd['id_vidcon']."/".'vidcondisetujui') ?>" data-nama="<?=$vd['namalembaga'] ?>" 
                                                    data-perihal="<?=$vd['perihal'] ?>" 
                                    ...
                                    <?= $pager->links('tblpengajuandisetujui','my_pager') ?>
                                </div>
                            </div>
                        </div>
                    </div>
