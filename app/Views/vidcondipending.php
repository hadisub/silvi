                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item">Daftar Pengajuan Bantuan Vidcon yang Dipending</li>
                        </ol>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="tblpengajuandipending" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach($vidcon_dipending as $vd): ?>
                                            <tr>
                                                <td><?= $i++ ?></td>
                                                <td><?= $vd['nomorsurat'] ?></td>
                                                ...
                                                <td style="white-space: nowrap;"><a class="btn btn-primary btn-circle btn-detail" data-tooltip="tooltip" data-toggle="modal" data-target="#modaldetailpengajuan" data-placement="top" title="Lihat rincian" 
                                                    ...
                                                    <a class="btn btn-success btn-circle btn-approve" data-tooltip="tooltip" data-toggle="modal" data-placement="top" data-target="#modalapprovepengajuan" title="Setujui pengajuan ini" data-url="<?=site_url("pengajuan/approvepengajuan/".$vd['id_vidcon']."/".'vidcondipending') ?>" data-nama="<?=$vd['namalembaga'] ?>" 
                                                        data-perihal="<?=$vd['perihal'] ?>" 
                                                        data-tanggal="<?=$vd['tglvidcon'] ?>" id="btn-approve" name="btn-approve"><i class="fas fa-check"></i></a>
                                                    <a class="btn btn-danger btn-circle btn-tolak" data-tooltip="tooltip" data-toggle="modal" data-placement="top" data-target="#modaltolakpengajuan" title="Tolak pengajuan ini" data-url="<?=site_url("pengajuan/tolakpengajuan/".$vd['id_vidcon']."/".'vidcondipending') ?>" data-nama="<?=$vd['namalembaga'] ?>" 
                                                    data-perihal="<?=$vd['perihal'] ?>" 
                                                    data-tanggal="<?=$vd['tglvidcon'] ?>" id="btn-tolak" name="btn-tolak"><i class="fas fa-times"></i></a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>        
                                        </tbody>
                                    </table>
                                    <?= $pager->links('tblpengajuandipending','my_pager') ?>
                                </div>
                            </div>
                        </div>
                    </div>
